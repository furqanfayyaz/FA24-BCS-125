...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/furqanfayyaz/FA24-BCS-125.git
   cd FA24-BCS-125/"Assignment 1"
   ```
...
The screenshots below show the application's Input Screen and Calculation Results Screen:
